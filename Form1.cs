...
public partial class Form1 : Form
{
    ...
    private void Form1_Shown(object? sender, EventArgs e)
    {
        RefreshWindows();
        UpdateSoundStatus();
        Log("Ready. Select the Classic client, record the catch sound, and capture the bobber red and blue feather pixels.");
    }
    ...
    private async Task RunBotAsync(WowWindowInfo window, Keys castKey, CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ...
            Log("Cast key pressed. Searching the WoW client for the newly landed bobber...");
    ...
    private void SetRunningUi(bool running)
    {
        ...
        btnCalibrateBobberPattern.Enabled = !running;
